...
<script>
	<#--用于获取后台json数据-->
	<#--1:获取全部数据，后台需转JSON格式 var sku=${itemList};-->
	<#--sku=${itemlist};-->
	<#--2：获取部分数据-->
	var sku=[
...
<body ng-app="pinyougou"  ng-controller="itemPageController" ng-init="loadDefaultSelect()">
<#include "head.ftl"/>
					...
					<div class="fl preview-wrap">
						...
						<div class="zoom">
							...
							<div id="preview" class="spec-preview">
                                <span class="jqzoom"><img jqimg="${imageList[0].url}" width="400" height="400" src="${imageList[0].url}" /></span>
							</div>
							<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd>
									...
									<a href="javascript:;"  ng-click="selectSpec('${spec.attributeName}','${specvalue}')" class="{{isSelect('${spec.attributeName}','${specvalue}')}}">
										${specvalue}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:void(0)" ng-click="addCart()"  class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
