...
public class JmsMessageSender {
     ...
     * Param
     */
    public  SendSmsResponse sendSms(String signName,String templateCode,String phoneNumbers,String param) throws ClientException {
//将值配置到application.properties中 通过environment.getProperty("配置文件的名字")来获取值；
